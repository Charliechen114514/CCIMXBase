...
static int charliesled_probe(struct platform_device* dev)
{
    pr_info("Succesfully catch the device and driver matches!\n");
...
static void charliesled_remove(struct platform_device* dev)
{
...
static const struct of_device_id charliesled_match[] = {
    {.compatible = "charlies_led"},
    {}
};
...
static struct platform_driver led_driver = {
    .driver = {
        .name = "charlies-led",
        .of_match_table = charliesled_match
    },
    .probe = charliesled_probe,
    .remove = charliesled_remove
};
